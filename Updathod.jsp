...
<html>
    ...
    <body>
         <%
        String hod = request.getParameter("department");
      ...
      ResultSet rs = stmt.executeQuery("select STAFF_ID,FNAME,MNAME,LNAME,To_char(DOB,'dd-mm-yyyy')"
              ...
              + ",SALARY,EXPRIENCE,USERNAME,PASSWORD from kumbhistaff WHERE JOB_PROFILE ='"+hod+"' ");
        ...
        <form action="updatestaff.jsp" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="staff_id" name="staff_id" value="<%=rs.getInt(1)%>"  readonly>
                </div>
