...
<html>
    ...
    <body>
     <%
        ...
        int result = stmt.executeUpdate("update kumbhistaff set FNAME='"+fname+"',MNAME='"+mname+"',LNAME='"+lname+"',DOB='"+dob+"'"
                ...
                + ",EXPRIENCE='"+experience+"',USERNAME='"+username+"',PASSWORD='"+password+"' where JOB_PROFILE='"+jobProfile+"' ");
