...
<body>
     <%
      ...
      ResultSet rs = stmt.executeQuery("select * from kumbhistaff where USERNAME ='"+session.getAttribute("username")+"' and"
    ...
    <div class="form-container">
        ...
        <form action="sbankadd.jsp" method="POST">
            
            <div class="d1">
                <label for="regino"><i class="fas fa-id-card"></i>Staff Id</label>
