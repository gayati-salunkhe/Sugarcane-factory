...
<html>
    ...
    <%
        ...
        int result = stmt.executeUpdate("insert into CHITBOY values(STAFF_ID.nextVal,"+cluster_id+",'"+fname+"','"+mname+"','"+lname+"','"+dob+"',"
                + ""+adharno+",'"+panNo+"',"+mobno+",'"+emailId+"','"+cAddress+"','"+pAddress+"','"+jobProfile+"','"+education+"',"
                + "'"+hireDate+"',"+sal+",'"+experience+"','"+username+"','"+password+"' )");
        
        if(result>0)
            {
                out.print(" <h1> <center> Chitboy  Information Add successfully..</center> <h1>");
