...
<html>
    ...
    <body>
     <%
        ...
        int result = stmt.executeUpdate("update upkrushi set FNAME='"+fname+"',MNAME='"+mname+"',LNAME='"+lname+"',DOB='"+dob+"'"
                ...
                + ",EXPRIENCE='"+experience+"',USERNAME='"+username+"',PASSWORD='"+password+"' where cluster_id='"+cluster_id+"' ");
