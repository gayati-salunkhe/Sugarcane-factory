...
<html>
    ...
    <body>
      ...
      ResultSet rs = stmt.executeQuery("select * from regi where REGI_NO ="+regino+" ");
       
     if (rs.next())
     { 
                  
     int ngatno = rs.getInt("NEARBY_GATNO");
     session.setAttribute("ngatno", ngatno);
...
<body>
    <div class="form-container">
        <h2><i class="fas fa-user-plus"></i> Approve Farmer Nond Form</h2>
        <form action="approvefrequest.jsp" method="POST">
            <div class="d1">
             ...
             <div class="d1">
                ...
                <label for="ngatno"><i class="fas fa-map-pin"></i> Lavan  date</label>
                <input type="text" name="ldate" id="ngatno" value="<%=rs.getString(12)%>">
            </div>
          ...
          <button type="submit"><i class="fas fa-paper-plane"></i>Approve</button>
        </form>
    </div>
</body>
